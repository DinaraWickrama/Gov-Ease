...
export default function OfficerDashboardPage() {
    ...
    // Hardcoded appointments for demonstration (officer's view)
    const upcomingAppointments = [
        { id: 1, citizen: "John Doe", service: "Driving License Renewal", date: "2025-08-20", time: "10:00 AM" },
        { id: 2, citizen: "Jane Smith", service: "Passport Application", date: "2025-09-05", time: "2:00 PM" },
    ];

    const pastAppointments = [
        { id: 3, citizen: "Alice Brown", service: "Vehicle Registration", date: "2025-07-15", time: "11:00 AM" },
    ];
    ...
    return (
        <div className="flex flex-col min-h-screen" style={{ backgroundColor: '#A7C7E7' }}>
            ...
            <header className="flex items-center justify-between p-4 bg-blue-100">
                ...
                <h1 className="text-2xl font-bold text-black">Officer Dashboard</h1>
            ...
            <main className="flex-grow flex flex-col p-8 space-y-8">
                        ...
                        <div className="space-y-4">
                            {upcomingAppointments.map(appt => (
                                <div key={appt.id} className="border-b pb-2">
                                    <p className="text-lg font-semibold">{appt.service} for {appt.citizen}</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-bold text-black mb-4">Document Management</h2>
                    <p className="text-gray-700 mb-4">Upload or review documents related to appointments.</p>
                    <input
                        type="file"
                    ...
                    <button className="mt-4 ml-4 bg-gray-600 text-white py-2 px-4 rounded-md hover:bg-gray-700">Review Documents</button>
                </div>
